...
def extraer_datos_reporte(ruta_o_contenido, es_ruta=True):
    if es_ruta:
        ...
        html_content = ruta_o_contenido if isinstance(ruta_o_contenido, str) else ruta_o_contenido.decode('utf-8', errors='ignore')
...
if __name__ == '__main__':
    archivo = 'reporte_excel_marodriguez_8.20.2026_10.44.03 AM.xls'
    try:
        resultados = extraer_datos_reporte(archivo)
        print("--- REPORTE DE PRODUCCIÓN EXTRAÍDO CON ÉXITO ---")
